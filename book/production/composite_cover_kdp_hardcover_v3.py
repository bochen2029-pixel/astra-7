...
OUT_PDF = OUT_DIR / "cover_wrap_hardcover_v3.pdf"
OUT_JPG = OUT_DIR / "cover_wrap_hardcover_v3.jpg"
...
if __name__ == "__main__":
    print("=== KDP HARDCOVER WRAP COMPOSITE v3 — The Long Watch ===")
    print("  v3: same design as v2; spine width corrected from KDP rejection error")
    print(f"  v2 was: 0.706\" (formula). v3 is: {SPINE_IN}\" (KDP-stated)")
    make_wrap()
    print("\nDone.\n")
