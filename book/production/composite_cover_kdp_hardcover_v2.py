...
OUT_PDF = OUT_DIR / "cover_wrap_hardcover_v2.pdf"
OUT_JPG = OUT_DIR / "cover_wrap_hardcover_v2.jpg"
...
if __name__ == "__main__":
    print("=== KDP HARDCOVER WRAP COMPOSITE v2 — The Long Watch ===")
    print("  v2 changes: darker navy (#060E1C) / space before colon in spine title / larger back text")
    make_wrap()
    print("\nDone.\n")
