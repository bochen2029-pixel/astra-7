...
| 6b–d | Remaining LIVE_RUN routing (operator picks): heartbeat-coverage expansion to n≥30 before thresholds (F-LIVE-2), Narrator-wired live pass (F-LIVE-5), drill-catch → corpus conversion (F-LIVE-3; `context window` extracted 2/2 runs) | LIVE_RUN §Routing | pending |
