...
| 6g+6h | Narrator sysprompt state-inventory (F-LIVE-20/26) + the gate artifact it exposed | LIVE_RUN 6f warrant | **DONE 2026-07-26** — see `LIVE_RUN_2026-07-26_6gh.md`. 6g FAILED its criterion because the instrument capped it (F-LIVE-28: gate demanded identifier syntax in a prose channel); 6h fixed the gate and re-measured both arms: state_coherent **1.000 zero-variance**, 24 turn failures → 0, PASS 11 → 15, all separated (F-LIVE-29). Established cost: non_degenerate 0.995 → 0.979 (F-LIVE-30) |
