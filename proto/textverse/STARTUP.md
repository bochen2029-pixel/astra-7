...
| 7 | **τ unit re-authoring (F-LIVE-14, OPEN):** provisional watch-length constant [chosen], assembler derives watch labels from τ-seconds, all 29 scenarios re-timed in real seconds, asserts re-verified, live re-measure | LIVE_RUN §6(b) | **next** — the harness currently censors its own state line once τ advances far enough |
