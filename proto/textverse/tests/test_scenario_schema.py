...
def test_load_watch_47_initial_state() -> None:
    ...
    assert scenario.initial_state.time.regime == 0    # REST
...
def test_load_scenario_accepts_regime_as_int() -> None:
    text = """
name: t
description: x
initial_state:
...
def test_load_scenario_accepts_regime_as_name() -> None:
    text = """
name: t
description: x
initial_state:
...
"""
    scenario = load_scenario(text)
    sb = build_initial_state_bus(scenario.initial_state)
    assert sb.time.regime == Regime.STL_REL
